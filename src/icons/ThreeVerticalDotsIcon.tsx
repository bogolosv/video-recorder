...
export const ThreeVerticalDotsIcon: FC<SVGProps<SVGSVGElement>> = (props) => {
    return (
        <svg width="18px" height="24px" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
